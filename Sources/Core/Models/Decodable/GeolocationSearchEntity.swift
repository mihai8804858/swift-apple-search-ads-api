...
public struct GeolocationSearchEntity: Decodable, Equatable, Sendable {
    ...
    /// Create an instance of `GeolocationSearchEntity`.
    ///
    /// - Parameters:
    ///     - id: The geographic location in the format of countryOrRegion|adminArea|locality.
    ///     - entity: A state or the equivalent according to its associated country.
    ///     - displayName: The geographic targeting location in the format of locality, adminArea, countryOrRegion.
    ///     - countryOrRegion: The geoterritory where you’re promoting your app in ISO alpha-2 country code format.
    ///     - adminArea: A city or the equivalent according to its associated adminArea.
    ///     - locality: The type of geography for targeting locations.
    public init(
        id: String,
