...
public struct PageDetail: Decodable, Equatable, Sendable {
    ...
    /// Create an instance of `PageDetail`.
    ///
    /// - Parameters:
    ///     - totalResults: The total number of entries that return for the operation.
    ///     - startIndex: The offset of the first entry that returns.
    ///     - itemsPerPage: The maximum number of entries that return for this operation.
