...
public struct SpendRow: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        localSpend: Money,
        tapInstallCPI: Money,
        tapInstallRate: Double,
        tapInstalls: Int,
        tapNewDownloads: Int,
        tapRedownloads: Int,
        taps: Int,
        totalAvgCPI: Money,
        totalInstallRate: Double,
        totalInstalls: Int,
        totalNewDownloads: Int,
        totalRedownloads: Int,
        ttr: Double,
        viewInstalls: Int,
        viewNewDownloads: Int,
        viewRedownloads: Int
    ) {
        self.avgCPM = avgCPM
        self.avgCPT = avgCPT
