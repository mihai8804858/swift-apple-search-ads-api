...
public struct AdGroupUpdate: Codable, Hashable, Sendable {
    ...
    public let status: NullCodable<AdGroup.Status>?
    ...
    public let defaultBidAmount: NullCodable<Money>?
    ...
    public let cpaGoal: NullCodable<Money>?
    ...
    public let automatedKeywordsOptIn: NullCodable<Bool>?
    ...
    public let targetingDimensions: NullCodable<TargetingDimensions>?

    public init(
        status: NullCodable<AdGroup.Status>? = nil,
        name: NullCodable<String>? = nil,
        defaultBidAmount: NullCodable<Money>? = nil,
        cpaGoal: NullCodable<Money>? = nil,
        automatedKeywordsOptIn: NullCodable<Bool>? = nil,
        startTime: NullCodable<Date>? = nil,
        endTime: NullCodable<Date>? = nil,
        targetingDimensions: NullCodable<TargetingDimensions>? = nil
    ) {
        self.status = status
        self.name = name
