...
public struct Condition: Encodable, Equatable, Sendable {
    public enum Operator: String, Encodable, Equatable, Sendable {
    ...
    ///     - operator: The operator values compare attributes to a list of specified values.
